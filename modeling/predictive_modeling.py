...
impr_mdl_data = pd.get_dummies(model_data['impr_mdl_cd'], drop_first = True)
...
model_data = pd.concat([model_data, buildingQuantity_data, remodelStatus_data, impr_mdl_data, property_code_data], axis = 1)
